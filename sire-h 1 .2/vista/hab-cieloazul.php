...
<head>
  ...
  <title>Habitación Cielo Azul - Hotel Sire-H</title>
...
<body>
        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              ...
              <li><a class="dropdown-item active" href="../vista/hab-cieloazul.php">Habitación Cielo Azul</a></li>
  ...
  <main class="container my-5">
    ...
    <div class="row mb-5">
      <div class="col-12 text-center">
        <h1 class="display-4 fw-bold text-brown">Habitación Cielo Azul</h1>
        <p class="lead text-muted">Disfruta de un cielo despejado desde la comodidad de tu habitación</p>
      </div>
    </div>
    ...
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 mb-4 mb-lg-0">
        <img src="../img/habitaciones2.0/imagen7.jpg" alt="Habitación Cielo Azul" class="img-fluid rounded shadow-lg">
      </div>
      <div class="col-lg-6">
        <h2 class="fw-bold text-brown mb-4">Descripción</h2>
        <p class="lead">La habitación Cielo Azul te ofrece vistas espectaculares del cielo caribeño, con un diseño relajante que combina elementos naturales y tonos de azul claro.</p>
        <p>Inspirada en la tranquilidad del cielo, esta habitación te transportará a un estado de completa relajación con su jacuzzi privado y acceso directo a la terraza.</p>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <ul class="list-unstyled">
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Vista panorámica al horizonte</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Cama queen-size premium</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Jacuzzi privado</li>
                </ul>
              </div>
              <div class="col-md-6">
                <ul class="list-unstyled">
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Acceso directo a la terraza</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Aire acondicionado y ventilador</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Minibar de cortesía</li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div class="row mb-5">
      <div class="col-12">
        ...
        <div class="row g-3">
          <div class="col-md-6">
            <img src="../img/habitaciones2.0/imagen8.jpg" alt="Interior Habitación Cielo Azul" class="img-fluid rounded shadow">
          </div>
          <div class="col-md-6">
            <img src="../img/habitaciones2.0/imagen9.jpg" alt="Vista desde la habitación" class="img-fluid rounded shadow">
          </div>
        </div>
      </div>
    </div>
            ...
            <form id="habitacionForm">
              <div class="mb-3">
                ...
                <select class="form-select" id="tipoHabitacion">
                  <option value="sencilla">Habitación Sencilla - $180.000</option>
                  <option value="doble">Habitación Doble - $250.000</option>
                  <option value="familiar">Habitación Familiar - $400.000</option>
                </select>
              </div>
              
              <div class="mb-3">
                <label for="personas" class="form-label">Número de personas:</label>
                <input type="number" class="form-control" id="personas" min="1" max="4" value="1">
              </div>
  ...
  <script src="../script/habitaciones.js"></script>
</body>
</html>