...
<head>
  ...
  <title>Habitación Mar Caribe - Hotel Sire-H</title>
...
<body>
  ...
  <header class="header container-fluid sticky-top">
    <div class="row align-items-center py-2">
      ...
      <div class="col-4 text-end">
        <a href="../vista/reserva.php" class="btn btn-warning reservar-btn">RESERVAR AHORA</a>
      </div>
    </div>
  </header>
        ...
        <ul class="navbar-nav mx-auto">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item active" href="../vista/hab-marcaribe.php">Habitación Mar Caribe</a></li>
  ...
  <main class="container my-5">
    ...
    <div class="row mb-5">
      <div class="col-12 text-center">
        <h1 class="display-4 fw-bold text-brown">Habitación Mar Caribe</h1>
        <p class="lead text-muted">Un lugar donde el mar y la brisa tropical te envolverán, con un diseño fresco y relajante.</p>
      </div>
    </div>
    ...
    <div class="row align-items-center mb-5">
      <div class="col-lg-6 mb-4 mb-lg-0">
        <img src="../img/habitaciones2.0/imagen1.jpg" alt="Habitación Mar Caribe" class="img-fluid rounded shadow-lg">
      </div>
      <div class="col-lg-6">
        <h2 class="fw-bold text-brown mb-4">Descripción</h2>
        <p class="lead">Sumérgete en el ambiente caribeño de nuestra habitación Mar Caribe, donde el mar y el aire fresco de la isla invaden cada rincón.</p>
        <p>Disfruta de una estancia inolvidable con vistas panorámicas al mar Caribe, comodidades de lujo y un servicio personalizado que hará de tu estadía una experiencia única.</p>
      </div>
    </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <ul class="list-unstyled">
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Vista panorámica al mar</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Cama king-size premium</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Balcón privado con hamaca</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Wi-Fi de alta velocidad gratuito</li>
                </ul>
              </div>
              <div class="col-md-6">
                <ul class="list-unstyled">
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Aire acondicionado y ventilador</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Servicio a la habitación 24h</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Minibar surtido</li>
                  <li class="mb-3"><i class="bi bi-check-circle-fill text-gold me-2"></i> Desayuno buffet incluido</li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div class="row mb-5">
      <div class="col-12">
        ...
        <div class="row g-3">
          <div class="col-md-6">
            <img src="../img/habitaciones2.0/imagen2.jpg" alt="Interior Habitación" class="img-fluid rounded shadow">
          </div>
          <div class="col-md-6">
            <img src="../img/habitaciones2.0/imagen3.jpg" alt="Vista desde la habitación" class="img-fluid rounded shadow">
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-6 mb-4 mb-lg-0">
        <div class="card border-0 shadow-sm">
          <div class="card-body p-4">
            <h2 class="fw-bold text-brown mb-4">Reserva ahora</h2>
  ...
  <select class="form-select" id="tipoHabitacion" required>
    <option value="sencilla">Habitación Sencilla - $180.000 (1 persona)</option>
    <option value="doble">Habitación Doble - $250.000 (2 personas)</option>
    <option value="familiar">Habitación Familiar - $400.000 (3-5 personas)</option>
  </select>
</div>

<div class="mb-3">
  <label for="personas" class="form-label">Número de personas:</label>
  <input type="number" class="form-control" id="personas" min="1" max="1" value="1" required>
</div>
              
              <div class="mb-3">
                <label for="entrada" class="form-label">Fecha de entrada:</label>
                <input type="date" class="form-control" id="entrada" required>
              </div>
              ...
              <button type="button" class="btn btn-warning w-100 py-3 fw-bold" onclick="agregarAlCarrito()">
                RESERVAR
              </button>
            </form>
          </div>
      ...
      <div class="col-lg-6">
        <div class="card border-0 shadow-sm">
          <div class="card-body p-4">
            <h2 class="fw-bold text-brown mb-4">Tu reserva</h2>
            <div id="carritoList" class="mb-4">
              <p class="text-muted">No hay elementos en el carrito</p>
            </div>
            
            <div class="d-flex justify-content-between align-items-center mb-4">
              <h3 class="h5 fw-bold text-brown mb-0">Total:</h3>
              <p class="h4 fw-bold text-gold mb-0" id="totalPrecio">$0</p>
            </div>
            
            <button id="comprarBtn" class="btn btn-brown w-100 py-3 fw-bold mb-3" onclick="realizarCompra()">
              REALIZAR COMPRA
            </button>
            
            <button id="reservarBtn" class="btn btn-outline-brown w-100 py-3 fw-bold" onclick="irAReserva()">
              RESERVAR AHORA
            </button>
          </div>
        </div>
  ...
  <script src="../habitaciones/habitaciones.js"></script>
</body>
</html>